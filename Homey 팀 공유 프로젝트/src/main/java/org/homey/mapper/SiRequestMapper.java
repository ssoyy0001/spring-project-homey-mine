...
//	public List<SiRequestVO> getList(); //시공의뢰 전체목록
	...
	public SiRequestVO select(int quoNo);//시공의뢰 등록시 quoNo로기존값 조회
	...
	public int update(SiRequestVO sireq); //시공의뢰 수정
	
	public List<SiRequestVO> myselectAllPaging(String mid, SireqCriteria cri); //나의 시공의뢰 전체목록 + 페이징
