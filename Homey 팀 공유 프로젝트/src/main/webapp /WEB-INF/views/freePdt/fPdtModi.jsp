...
<!-----------------------start form----------------------->
	        <form action="/freePdt/modify" method="post" role="form" enctype="multipart/form-data">
	            ...
	            <div class="form-group mt-3">
	                ...
	                <select name="fpState">
				        <option value="0" ${fpvo.fpState == '0' ? 'selected' : ''}>나눔중</option>
				        <option value="1" ${fpvo.fpState == '1' ? 'selected' : ''}>신청마감</option>
				    </select>
	            </div>
	            ...
	            <div class="form-group mt-3">
	                ...
	                <input type="date" class= "regiItem" name="fpGetDate" value="${fpvo.fpGetDate }" min="2020-01-01" max="2030-12-31">
	            </div>
