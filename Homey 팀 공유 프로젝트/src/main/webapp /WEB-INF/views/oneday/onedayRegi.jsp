...
<section id="project-details" class="project-details">
    ...
    <div class="col-lg-8 mx-auto">
	    <div class="portfolio-description">
	        ...
	        <hr>
<!-----------------------start form----------------------->
	        <form action="/oneday/register" method="post" role="form" enctype="multipart/form-data">
	            ...
	            <div class="form-group mt-3">
	                ...
	                <input type="text" name="odPlace" class="regiItem" required>
	            </div>
	            
	            <div class="form-group mt-3">
	                <label class="regiItemNm"><strong>* 진행자</strong></label>
	                <input type="text" name="odMc" class="regiItem" required>
	            </div>
	            
	            <div class="form-group mt-3">
	                <label class="regiItemNm"><strong>* 예상소요시간</strong></label>
	                <input type="text" name="odTime" class="regiItem" placeholder="ex) O시간 OO분">
	            </div>
	            
	            <div class="form-group mt-3">
	                <label class="regiItemNm"><strong>* 모집인원</strong></label>
	                <input type="number" name="odPeople" class="regiItem" value="0" min="0" max="100" step="1">
	            </div>
	            ...
	            <div class="form-group mt-3">
	                ...
	                <input type="text" name="odName" class="regiItem" required>
	            </div>
	            
	            <div class="form-group mt-3">
	                <label class="regiItemNm"><strong>* 제   목</strong></label>
	                <input type="text" name="odTitle" class="form-control" required>
	            </div>
	            
	            <div class="form-group mt-3">
		            <label class="regiItemNm"><strong>* 내   용</strong></label>
		            <textarea class="form-control" name="odContent" id="" rows="10" required></textarea>
	        	</div>
...
odDeadline.addEventListener('change', function () {
	if (new Date(this.value) > new Date(odDate.value)) {
        alert("진행일이 모집마감일보다 빠릅니다. \n 모집마감일을 다시 확인하세요.");
