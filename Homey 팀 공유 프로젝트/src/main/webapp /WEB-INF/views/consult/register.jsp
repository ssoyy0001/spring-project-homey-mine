...
<body>
	...
	<main id="main">
				...
				<div class="row justify-content-between gy-4 mt-4">
							...
							<form action="/consult/register" method="post" role="form">
								...
								<div class="form-group">
									<label class="radio-inline"> <input type="radio"
										...
										name="buildingType" id="buildingType3" value="주택"> 주택
										&nbsp;
									</label> <label class="radio-inline"> <input type="radio"
										name="buildingType" id="buildingType4" value="오피스텔">
										오피스텔 &nbsp;
									</label> <label class="radio-inline"> <input type="radio"
								...
								<div class="form-group">
									<label class="radio-inline"> <input type="radio"
										...
										name="scheduledDate" id="scheduledDate3" value="미정">
										미정 &nbsp;
									</label> <label class="radio-inline"> <input type="radio"
									...
									<div id="callout">
										종합 리모델링 공사의 경우, 시공까지 2~3주 이상 여유가 있어야 상담진행이 가능합니다. <br>시공이
										임박했거나 3달 이후인 경우 상담이 어려울 수 있습니다.
									</div>
								</div>
								<hr>
								<br>
								...
								<div class="form-group"
									style="display: inline-block; width: 300px; line-height: 50px;">
									<label class="checkbox-inline"> <input type="checkbox"
										name="tiling" id="tilingCheck" class="item" value="1">도배/벽
										&nbsp;
									</label> <label class="checkbox-inline"> <input type="checkbox"
										name="flooring" id="flooringCheck" class="item" value="1">바닥
										&nbsp;
									</label> <label class="checkbox-inline"> <input type="checkbox"
										name="kitchen" id="kitchenCheck" class="item" value="1">주방
										&nbsp;
									</label> <label class="checkbox-inline"> <input type="checkbox"
										name="bathroom" id="bathroomCheck" class="item" value="1">욕실
										&nbsp;
									</label> <label class="checkbox-inline"> <input type="checkbox"
										name="entrance" id="entranceCheck" class="item" value="1">현관
										&nbsp;
									</label> <label class="checkbox-inline"> <input type="checkbox"
										name="balcony" id="balconyCheck" class="item" value="1">발코니
										&nbsp;
									</label> <label class="checkbox-inline"> <input type="checkbox"
										name="lighting" id="lightingCheck" class="item" value="1">조명
										&nbsp;
									</label> <label class="checkbox-inline"> <input type="checkbox"
										name="door" id="doorCheck" class="item" value="1">문
										&nbsp;
									</label> <label class="checkbox-inline"> <input type="checkbox"
										name="etc" id="etcCheck" class="item" value="1">그
										외(문의) &nbsp;
									</label>
								</div>
								<hr>
								...
								<div class="form-group row" style="margin-bottom: 10px">
									...
									<div class="col-sm-3">
										<input type="text" name="postcode" id="postcode"
											class="form-control" required placeholder="우편번호">
									</div>
									<div class="col-sm-2">
								...
								<div class="form-check">
									<!--flexCheckDefault이면 미체크, flexCheckChecked이면 체크된 상태로 나타남 -->
								...
								<div id="myModal" class="modal">
									<div class="modal-content">
										...
										<p>① “HOMEY”은(는) 제 7조 제 2항의 신청서기재사항 이외에 “이용자”의 콘텐츠이용에 필요한
											...
											수집하는 때에는 당해 “이용자”의 동의를 받습니다. ③ “HOMEY”은(는) “이용자”가 이용신청 등에서
											제공한 정보와 제 1항에 의하여 수집한 정보를 당해 “이용자”의 동의 없이 목적 외로 이용하거나 제 3자에게
					...
					<div class="col-lg-3">
						<div class="portfolio-info"
							style="background: linear-gradient(#FDDCAA, #FDF5E6); padding: 5px 5px 5px">
							<h3>
								견적 상담, <br>어떻게 이루어지나요?
							</h3>
							<ul>
								<li><strong>견적 상담 신청</strong> <span>원하시는 인테리어 시공의
										정보를<br> 알려주세요 ✏
								</span></li>
								<li><strong>해피콜</strong> <span>해피콜 시간에 상담사가 연락드려요.
										간단한 상담과 방문 실측 스케줄을 <br>상의해요 🤗
								</span></li>
								<li><strong>방문 실측 견적 상담</strong> <span>실측 후 견적서를
										제공해드려요 🏠 </span></li>
							</ul>
						</div>
					</div>
		...
		<!-- End Projet Details Section (END 견적상담 입력 폼)-->
