...
<section id="project-details" class="project-details">
    ...
    <div class="col-lg-8 mx-auto">
	    <div class="portfolio-description">
	        <h2>📝원데이클래스 참여후기 수정</h2>
	        <span id="notice">* 항목은 필수 입력 항목입니다.</span>
	        <hr>
<!-----------------------start form----------------------->
	        <form action="/odReview/modify" method="post" id="modiForm" role="form" enctype="multipart/form-data">
	            
	            <input type="hidden" name="orNo" value="${orvo.orNo }">
	            
	            <div class="form-group mt-3">
	                <label class="regiItemNm"><strong>* 작성자</strong></label>
	                <input type="text" name="mid" class="staticItem" value="${orvo.mid }" readonly>
	            </div>
	            ...
	            <div class="form-group mt-3">
	                ...
	                <input type="text" name="orTitle" class="form-control" value="${orvo.orTitle }">
	            </div>
	            
	            <div class="form-group mt-3">
		            <label class="regiItemNm"><strong>* 내   용</strong></label>
		            <textarea class="form-control" name="orContent" id="" rows="10">${orvo.orContent }</textarea>
	        	</div>
