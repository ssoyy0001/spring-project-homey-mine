...
<section id="project-details" class="project-details">
    ...
    <div class="col-lg-8 mx-auto">
	    <div class="portfolio-description">
	        ...
	        <hr>
<!-----------------------start form----------------------->
	        <form action="/fpReview/register" method="post" id="regiForm" role="form" enctype="multipart/form-data">
	            ...
	            <div class="form-group mt-3">
	                ...
	                <input type="text" name="prTitle" class="form-control" required>
	            </div>
	            
	            <div class="form-group mt-3">
		            <label class="regiItemNm"><strong>* 내   용</strong></label>
		            <textarea class="form-control" name="prContent" id="" rows="10"></textarea>
	        	</div>
