										...
										<form action="/sirequest/sireqRegister" method="get"
											...
											<div class="form-group">
												...
												~ <input name="constScheduleEnd"
													value='<c:out value="${qvo.constScheduleEnd}" />'
													readonly pattern="yyyy-MM-dd" class="form-control">
											</div>
											<br>
											<div class="form-group">
											...
											<div class="form-group">
												<label>평수</label> <input name="pyeongsu"
													value='<c:out value="${cvo.pyeongsu}" />'
													readonly class="form-control">
											</div>
											<br> 
												...
												<div id="demolDiv"
													...
													<c:choose>
														<c:when test="${ivo.tilingD != null}">
															<label class="checkbox-inline"> <input
																...
																class="item" value="${ivo.tilingD}" />&nbsp; 도배/벽 &nbsp; 철거비용: <input
																type="number" id="operand1" 
																style="border: 1px solid #ccc;" readonly value="${ivo.tilingD}">
													...
													<c:choose>
														<c:when test="${ivo.flooringD != null}">
															<label class="checkbox-inline"> <input
																type="checkbox" name="ivo.flooringD" id="flooringDCheck"
																class="item" value="${ivo.flooringD}" />&nbsp; 바닥 &nbsp; 철거비용: <input
																type="number" id="operand2"
																style="border: 1px solid #ccc;" readonly value="${ivo.flooringD}">
															</label>
															<br>
														</c:when>
													</c:choose>
													<c:choose>
														<c:when test="${ivo.kitchenD != null}">
															<label class="checkbox-inline"> <input
																...
																class="item" value="${ivo.kitchenD}" />&nbsp; 주방 &nbsp; 철거비용: <input
																type="number" id="operand3"
																style="border: 1px solid #ccc;" readonly value="${ivo.kitchenD}">
															</label>
															<br>
														</c:when>
													</c:choose>
													<c:choose>
														<c:when test="${ivo.bathroomD != null}">
															<label class="checkbox-inline"> <input
																type="checkbox" name="ivo.bathroomD" id="bathroomDCheck"
																class="item" value="${ivo.bathroomD}" />&nbsp; 욕실 &nbsp; 철거비용: <input
																type="number" id="operand4"
																style="border: 1px solid #ccc;" readonly value="${ivo.bathroomD}">
															</label>
															<br>
														</c:when>
													</c:choose>
													<c:choose>
														<c:when test="${ivo.entranceD != null}">
															<label class="checkbox-inline"> <input
																type="checkbox" name="ivo.entranceD" id="entranceDCheck"
																class="item" value="${ivo.entranceD}" />&nbsp; 현관 &nbsp; 철거비용: <input
																type="number" id="operand5"
																style="border: 1px solid #ccc;" readonly value="${ivo.entranceD}">
															</label>
															<br>
														</c:when>
													</c:choose>
													<c:choose>
														<c:when test="${ivo.balconyD != null}">
															<label class="checkbox-inline"> <input
																...
																class="item" value="${ivo.balconyD}" />&nbsp; 발코니 &nbsp; 철거비용: <input
																type="number" id="operand6"
																style="border: 1px solid #ccc;" readonly value="${ivo.balconyD}">
															</label>
															<br>
														</c:when>
													</c:choose>
													<c:choose>
														<c:when test="${ivo.lightingD != null}">
															<label class="checkbox-inline"> <input
																type="checkbox" name="ivo.lightingD" id="lightingDCheck"
																class="item" value="${ivo.lightingD}" />&nbsp; 조명 &nbsp; 철거비용: <input
																type="number" id="operand7"
																style="border: 1px solid #ccc;" readonly value="${ivo.lightingD}">
															</label>
															<br>
														</c:when>
													</c:choose>
													<c:choose>
														<c:when test="${ivo.doorD != null}">
															<label class="checkbox-inline"> <input
																...
																class="item" value="${ivo.doorD}" />&nbsp; 문 &nbsp; 철거비용: <input
																type="number" id="operand8"
																style="border: 1px solid #ccc;" readonly value="${ivo.doorD}">
															</label>
															<br>
														</c:when>
													</c:choose>
													<c:choose>
														<c:when test="${ivo.etcD != null}">
															<label class="checkbox-inline"> <input
													...
													<c:choose>
														<c:when test="${ivo.tiling != null}">
															<label class="checkbox-inline"> <input
																...
																class="item" value="${ivo.tiling}" />&nbsp; 도배/벽 &nbsp; 시공비용: <input
																type="number" id="operand_1"
																style="border: 1px solid #ccc;" readonly value="${ivo.tiling}">
															</label>
															<br>
														</c:when>
													</c:choose>
													<c:choose>
														<c:when test="${ivo.flooring != null}">
															<label class="checkbox-inline"> <input
																...
																class="item" value="${ivo.flooring}" />&nbsp; 바닥 &nbsp; 시공비용: <input
																type="number" id="operand_2"
																style="border: 1px solid #ccc;" readonly value="${ivo.flooring}">
															</label>
															<br>
														</c:when>
													</c:choose>
													<c:choose>
														<c:when test="${ivo.kitchen != null}">
															<label class="checkbox-inline"> <input
																...
																class="item" value="${ivo.kitchen}" />&nbsp; 주방 &nbsp; 시공비용: <input
																type="number" id="operand_3"
																style="border: 1px solid #ccc;" readonly value="${ivo.kitchen}">
															</label>
															<br>
														</c:when>
													</c:choose>
													<c:choose>
														<c:when test="${ivo.bathroom != null}">
															<label class="checkbox-inline"> <input
																...
																class="item" value="${ivo.bathroom}" />&nbsp; 욕실 &nbsp; 시공비용: <input
																type="number" id="operand_4"
																style="border: 1px solid #ccc;" readonly value="${ivo.bathroom}">
															</label>
															<br>
														</c:when>
													</c:choose>
													<c:choose>
														<c:when test="${ivo.entrance != null}">
															<label class="checkbox-inline"> <input
																...
																class="item" value="${ivo.entrance}" />&nbsp; 현관 &nbsp; 시공비용: <input
																type="number" id="operand_5"
																style="border: 1px solid #ccc;" readonly value="${ivo.entrance}">
															</label>
															<br>
														</c:when>
													</c:choose>
													<c:choose>
														<c:when test="${ivo.balcony != null}">
															<label class="checkbox-inline"> <input
																...
																class="item" value="${ivo.balcony}" />&nbsp; 발코니 &nbsp; 시공비용: <input
																type="number" id="operand_6"
																style="border: 1px solid #ccc;" readonly value="${ivo.balcony}">
															</label>
															<br>
														</c:when>
													</c:choose>
													<c:choose>
														<c:when test="${ivo.lighting != null}">
															<label class="checkbox-inline"> <input
																...
																class="item" value="${ivo.lighting}" />&nbsp; 조명 &nbsp; 시공비용: <input
																type="number" id="operand_7"
																style="border: 1px solid #ccc;" readonly value="${ivo.lighting}">
															</label>
															<br>
														</c:when>
													</c:choose>
													<c:choose>
														<c:when test="${ivo.door != null}">
															<label class="checkbox-inline"> <input
																...
																class="item" value="${ivo.door}" />&nbsp; 문 &nbsp; 시공비용: <input
																type="number" id="operand_8"
																style="border: 1px solid #ccc;" readonly value="${ivo.door}">
															</label>
															<br>
														</c:when>
													</c:choose>
													<c:choose>
														<c:when test="${ivo.etc != null}">
															<label class="checkbox-inline"> <input
											...
											<br>
											<div class="form-group">
												<label>철거비용</label> <input name="quotationvo.demolTotal" id="demolTotal" value='<c:out value="${qvo.demolTotal}" />'
													readonly class="form-control"> 
											...
											<br>
											<div class="form-group">
												<label>시공비용</label> <input name="quotationvo.constTotal" id="constTotal" value='<c:out value="${qvo.constTotal}" />'
													readonly class="form-control">
											</div>
											<br>

											<div class="form-group">
												<label>총 시공금액</label> <input name="sigongTotal" id="sigongTotal" value='<c:out value="${qvo.total}" />' readonly
													class="form-control">
											</div>
											<br>
											
											<input type="hidden" name="mvo.mid" value="${cvo.mid}" />
											<input type="hidden" name="quotationvo.quoNo" value="${qvo.quoNo }" />
											<input type="hidden" name="consultvo.consultNo" value="${cvo.consultNo}" />
											<input type="hidden" name="ivo.itemNo" value="${cvo.item.itemNo}" />
											<input type="hidden" name="quotationvo.demolTotal" value="${qvo.demolTotal}" />
											<input type="hidden" name="quotationvo.constTotal" value="${qvo.constTotal}" />
