				...
				<div class="row g-5">
					<div class="col-lg-8 mx-auto">
						<article class="blog-details">
							...
							<div class="content">
								<br>
								<form action="/sischedule/sicheModify" method="POST" role="form"
									id="actionFrm">
									<input type="hidden" name="sicheNo" value="${sicheVO.sicheNo }">
									<!--------------------- 후기 상세조회 -------------------->
...
$("#modiBtn").on("click",function(e){
    ...
    $.ajax({
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            var dbSicheNo = data[i].sicheNo;
            
			if (dbSicheNo != sicheNo) {
