				...
				<div class="row justify-content-between gy-4 mt-4">
					<div class="col-lg-8 mx-auto">
						<div class="portfolio-description">
							...
							<hr>
							<!-----------------------start form----------------------->
							<form action="/showcase/caseModify" method="post" role="form"
								enctype="multipart/form-data">

								<div class="form-group mt-3">
									<label class="caseNm"><strong>작업등록번호</strong></label> <input
										type="number" name="cicheNo" class="caseItem" value="${view.sicheNo }" readonly>
								</div>

								<div class="form-group mt-3">
									<label class="caseNm"><strong>시공비용</strong></label> <input
										type="text" name="totalRange" class="caseItem" value="${view.totalRange }" readonly>
								</div>

								<div class="form-group mt-3">
									<label class="caseNm"><strong>평수</strong></label> <input
										type="text" name="sizeRange" class="caseItem" value="${view.sizeRange }"readonly>
								</div>

								<div class="form-group mt-3">
									<label class="caseNm"><strong>주거유형</strong></label> <input
										type="text" name="buildingType" class="caseItem"
										value="${view.buildingType }" readonly>
								</div>
								<div class="form-group mt-3">
								...
								<div class="form-group mt-3">
									<label class="caseNm"><strong> 제 목</strong></label> <input
										type="text" name="scTitle" class="form-control" value="${view.scTitle }"required>
								</div>

								<div class="form-group mt-3">
									<label class="caseNm"><strong> 내 용</strong></label>
									<textarea class="form-control" name="scContent" id="" rows="10"
										required>${view.scContent }</textarea>
								</div>
								...
								<input type="hidden" name="scid" value="${view.scid }">
