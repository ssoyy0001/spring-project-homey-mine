								...
								<div class="card-front">
									<div class="center-wrap">
										<div class="section text-center">
											...
											<form role="form" action="/gen/findID" method="post">
												<div style="float: left;" id="findID-msg"></div>
												...
												<input type="hidden" name="${_csrf.parameterName }"
													...
													value="Find ID" class="btn mt-4" id="findID">
											</form>
	  ...
	  $('#findID').on('click', function(e) {
	    ...
	    $.ajax({
	      ...
	      success: function(result, status, xhr) {
	        $('#findID-msg').html('<span style="color: green;font-weight: bold;">회원님의 아이디는 ' + result + ' 입니다.</span>');
	      },
